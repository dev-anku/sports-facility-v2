...
const AboutSection = () => {
  return (
    <section
      id="about"
      className="mx-6 my-8 flex flex-col items-center justify-center gap-16 xl:w-4/6 xl:mx-auto xl:my-12 xl:flex-row"
    >
      <div>
        <Image
          src={images[9]}
      ...
      <div className="flex flex-col gap-4 font-text text-gray-600 xl:text-xl">
        ...
        <p>
          With a proven track record of successfully completing over 1500+
          projects across India, we have helped transform sports infrastructure
          nationwide. Our commitment to excellence ensures that every project
          meets the highest standards of safety, quality, and performance.
        </p>
        <p>
          At sports facility we believe that great sports facilities are more
          than just playing surfaces, they&apos;re the foundation of passion,
          competition, and community engagement. From concept to completion, we
