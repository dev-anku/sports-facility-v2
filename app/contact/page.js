...
export const metadata = {
    ...
    alternates: {
        canonical: "https://sports-facility.in/contact",
    },
};
        ...
        <section className="mx-6 my-16 flex flex-col justify-center gap-8 max-sm:text-center xl:mx-auto xl:w-4/6 xl:flex-row">
            <div className="xl:w-2/5">
                ...
                <p className="mt-4 font-text text-lg text-gray-500">
                    Have questions or need expert advice on sports surfaces?
                    We&apos;re here to help! Reach out to us for inquiries,
                    project consultations, or collaborations. Let&apos;s build
                    the perfect sports facility together
                </p>
                <div className="mt-3 flex justify-center gap-4 xl:justify-start">
                    ...
                    <a
                        href="mailto:ridhamteam125@gmail.com"
                        className="h-8 w-8"
                    >
                        <Image
            ...
            <div className="flex flex-col gap-4 bg-gray-100 p-4 py-8 xl:w-3/5">
                ...
                <div className="flex flex-col gap-2">
                    {contactData.map((contact) => (
                        <p
                            className="font-text leading-normal"
                            key={contact.label}
                        >
